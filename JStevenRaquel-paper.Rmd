...
gonnet_df2 %>%
  ...
  theme_bw() +
  xlab("Bar Attendance") + ylab("Degree")
```

Figure 4, which depicts a boxplot of degree, stratified by gender, we observe that the average degree for  
