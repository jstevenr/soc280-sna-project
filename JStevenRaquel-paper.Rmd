...
gonnet.degreedist
summary(gonnet ~ odegree(0:3, gonnet_df2$gender))

# creating a network object, symmetric
gonnet_net <- network(gonnet, directed = TRUE) 

# adding bar attendance on graph
...
ergm_model3 <- ergm(gonnet_sym_net ~ edges + degree(d = c(2:8)))
```
