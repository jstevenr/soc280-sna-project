...
ggnet2(gonnet_net_bar,
       color = "gender", 
       palette = c("M" = "lightblue", "F" = "salmon", "BAR" = "grey"),
...
```{r sociogram-sna, fig.cap = "Sociogram of the gonorrhea network.", echo = F}
# data is loaded as gonnet
par(mfrow = c(1,1))
set.seed(10)
org_coord <- 
...
ergm_model4 <- ergm(gonnet_net ~ edges + nodemix("gender"))
summary(ergm_model4)
