...
```{r figure-bar-degree, fig.cap = "Distribution of number of partners, by bar attendance.", echo=FALSE}
...
```{r figure-gender-degree, fig.cap = "Distribution of partners, by gender.", echo=FALSE}
