...
* $d_2(y) \approx 2.749$, for `degree1`, implies that the odds of a node having degree 1 in a network such as this is $\exp(2.758) \approx 15.652$, all other things equal.

* $d_3(y) \approx 1.464$ for `degree2` implies that the odds of a node having degree 2 in a network such as this is $\exp(1.484) \approx 4.449$, all other things equal.
