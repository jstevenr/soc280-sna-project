...
- The original study followed an _egocentric_ social network desing in which individuals provided inforamtion on themselves and others within their social networks, who are referred to as alters (Valente)
...
- MCMC estimate for `degree1`: $\approx 2.4759$, implying that all else equal, a node having a degree of 1 increases its odds of having a tie by $\exp(2.4759) \approx 11.892$
- MCMC estimate for `degree2`: $\approx 1.471$
